    ...
    return (
        <section id="projects" className="py-24 bg-white relative">
            <div className="container mx-auto px-6 max-w-6xl">
                ...
                >
                    <div>
                        <h2 className="text-4xl md:text-5xl font-light mb-4 text-slate-900 tracking-tight">Engineering Demos</h2>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="p-8 flex flex-col flex-grow relative z-10">
                                    ...
                                    <h3 className="text-xl font-medium mb-2 leading-tight text-slate-900 group-hover:text-[#A31F34] transition-colors tracking-tight">
                                        {project.title}
                                    </h3>
                                    <h4 className="text-[11px] font-bold text-[#FF530D] mb-4 tracking-[0.1em] uppercase">
                                        {project.subtitle}
                                    </h4>
                                    ...
                                    <div className="mt-auto pt-6 border-t border-slate-50 flex items-center h-4">
                                        {/* documentation pending removed */}
                                    </div>
                                </div>
